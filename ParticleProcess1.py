...
def get_average_image_path(frame_num, base_dir):
    # Always use the average image for frame 8000
    average_image_filename = 'average_image8000.png'
...
def process_frame_wrapper(frame_data):
    try:
        ...
        logging.error(f"Error processing frame {frame_data[0]}: {e}")
        return None
